                    ...
                    <tbody>
                      ...
                      >
                        ...
                        <td class="delete-item">
                          <a @click="removeItem(keranjang.id)" href="#"
              ...
              <div class="col-lg-12">
                <div class="proceed-checkout">
                  <ul>
                    ...
                    <li class="subtotal mt-3">
                      Pajak <span>10% (${{ jumlahPajak }}.00)</span>
                    </li>
                    <li class="subtotal mt-3">
...
export default {
  ...
  computed: {
    ...
    jumlahPajak: function() {
      return (this.totalHarga * 10) / 100;
    },
    totalBiaya: function() {
      return this.totalHarga + this.jumlahPajak;
    },
  },
};
</script>
